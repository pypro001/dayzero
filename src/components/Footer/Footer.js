        ...
        <>
            <section className="footer-section">
                <div className='card card-2'>
                    ...
                    <p class="tagline">Turning Your Vision into an Actionable Blueprint to Brilliance.</p>
                </div>
                <div className='card'>
                    <h3>Platform</h3>
                    <ul>
                        <li> <Link to='' className='footer-nav-link'>Features</Link></li>
                        <li> <Link to='' className='footer-nav-link'>Pricing</Link></li>
                        <li> <Link to='' className='footer-nav-link'>Login</Link></li>
                        <li> <Link to='' className='footer-nav-link'>Sign up</Link></li>
                ...
                <div className='card'>
                    <h3>Company</h3>
                    <ul>
                        <li> <Link to='' className='footer-nav-link'>About</Link></li>
                        <li> <Link to='' className='footer-nav-link'>Career</Link></li>
                        <li> <Link to='' className='footer-nav-link'>Blog</Link></li>
                        <li> <Link to='' className='footer-nav-link'>Contact us</Link></li>
                ...
                <div className='card'>
                    <h3>Legal</h3>
                    <ul>
                        <li> <Link to='' className='footer-nav-link'>Refund Policy</Link></li>
                        <li> <Link to='' className='footer-nav-link'>Terms & Conditions</Link></li>
                        <li> <Link to='' className='footer-nav-link'>Privacy Policy</Link></li>
                        <li> <Link to='' className='footer-nav-link'>FAQ</Link></li>
                ...
                <div class="follow_links">
                    <img alt="logo" loading="lazy" width="26" height="26" decoding="async"  src={linkedinLogo}/>
                        <img alt="logo" loading="lazy" width="26" height="26" decoding="async" data-nimg="1" src={youtubeLogo}/>
                            <img alt="logo" loading="lazy" width="26" height="22" decoding="async" data-nimg="1" src={twitterLogo}/>
                                <img alt="logo" loading="lazy" width="26" height="26" decoding="async" data-nimg="1" src={discordLogo}/>
